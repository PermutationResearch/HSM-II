    ...
    <div className="space-y-3">
      ...
      {runs.length === 0 ? (
        <p
          className={
            layout === "admin"
              ? "rounded-2xl border border-dashed border-[#30363D] bg-[#0d1117]/80 px-4 py-6 text-center text-sm text-[#8B949E]"
...
function AgentRunCard({
  ...
  const shell = cn(
    ...
    layout === "admin" ? "border border-[#30363D] bg-[#0d1117]" : "border border-border bg-card",
    onTaskClick &&
      (layout === "admin"
        ? "cursor-pointer hover:border-[#58a6ff]/40 hover:bg-[#0d1117]"
      ...
      <div className="mb-2 flex items-start justify-between gap-2">
        <div className="min-w-0">
          <p className="truncate font-mono text-[11px] font-normal uppercase tracking-[0.06em] text-[#999999]">
            ...
            {isLive ? (
              <span className="ml-2 rounded border border-[#4A9E5C]/40 bg-[#4A9E5C]/15 px-1.5 py-0.5 text-[10px] font-semibold normal-case tracking-normal text-[#4A9E5C]">
                LIVE
              </span>
            ) : runFailed ? (
              <span className="ml-2 rounded border border-[#D71921]/45 bg-[#D71921]/12 px-1.5 py-0.5 text-[10px] font-semibold normal-case tracking-normal text-[#F85149]">
                FAILED
              </span>
            ) : runSucceeded ? (
              <span className="ml-2 rounded border border-[#388BFD]/35 bg-[#388BFD]/10 px-1.5 py-0.5 text-[10px] font-semibold normal-case tracking-normal text-[#79C0FF]">
                DONE
              </span>
            ) : (
