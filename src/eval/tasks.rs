        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("api_design".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("api_design".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("api_design".into()),
                },
                Turn {
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("debugging".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("debugging".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("debugging".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("architecture".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("architecture".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("architecture".into()),
                },
                Turn {
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("refactoring".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("refactoring".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("testing".into()),
                },
                Turn {
                ...
                Turn {
                    user: "Great. Now review our complete test strategy from both sessions and identify any gaps in coverage.".into(),
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("ml_pipeline".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("ml_pipeline".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("ml_pipeline".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("feature_engineering".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("feature_engineering".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("deployment".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("deployment".into()),
                },
                Turn {
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("data_pipeline".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("data_pipeline".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("experiment_tracking".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("experiment_tracking".into()),
                },
            ],
        },
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("strategy".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("strategy".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("strategy".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("pricing".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("pricing".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("competitive".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("competitive".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("hiring".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("hiring".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("product".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("product".into()),
                },
            ],
        },
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("research".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("research".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("research".into()),
                },
            ],
        },
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("writing".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("writing".into()),
                },
            ],
        },
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("healthcare_tech".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("healthcare_tech".into()),
                },
                Turn {
                    ...
                    session: 3, requires_recall: true, domain: Some("healthcare_tech".into()),
                },
                Turn {
        ...
        EvalTask {
            ...
            turns: vec![
                Turn {
                    ...
                    session: 1, requires_recall: false, domain: Some("notification".into()),
                },
                Turn {
                    ...
                    session: 1, requires_recall: true, domain: Some("notification".into()),
                },
                Turn {
                    ...
                    session: 2, requires_recall: true, domain: Some("notification".into()),
                },
                Turn {
                    ...
                    session: 3, requires_recall: true, domain: Some("notification".into()),
                },
            ],
        },
    ]
